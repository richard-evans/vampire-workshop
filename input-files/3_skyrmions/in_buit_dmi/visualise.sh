...
sp "plot.data" u 3:(\$5>-0.1?\$4:0/0):(\$5<0.1?\$5:0/0):(\$6):(\$7):(\$8):8 w vectors palette lw 1.5 t 'M', '' u 3:(\$5>-0.1?\$4:0/0):(\$5<0.1?\$5:0/0):8 w points palette pt 7 ps 1 t 'Mz'
set view 90,0
sp "plot.data" u 3:(\$5>-0.1?\$4:0/0):(\$5<0.1?\$5:0/0):(\$6):(\$7):(\$8):8 w vectors palette lw 1.5 t 'M', '' u 3:(\$5>-0.1?\$4:0/0):(\$5<0.1?\$5:0/0):8 w points palette pt 7 ps 1 t 'Mz'
